...
<svg width="26" height="26" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bgGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#4b1c91"/>
  ...
  />
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">Novaly</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="{{ route('admin.authors.index') }}" class="menu-link">
                ...
                <div data-i18n="Authors">Tác giả</div>
            </a>
        </li>

        <!-- Stories Management -->
        <li class="menu-item">
            <a href="{{ route('admin.stories.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-book"></i>
                <div data-i18n="Stories">Truyện</div>
            </a>
        </li>

        <!-- Apps & Pages -->
        <li class="menu-header small text-uppercase"><span class="menu-header-text" data-i18n="Apps & Pages">Apps &amp; Novaly</span></li>
