                ...
                <form action="{{ route('admin.genres.update', $genre->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                            id="name" name="name" value="{{ old('name', $genre->name) }}" placeholder="Nhập tên thể loại">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slug') is-invalid @enderror"
                            id="slug" name="slug" value="{{ old('slug', $genre->slug) }}" placeholder="Slug sẽ tự động tạo từ tên">
