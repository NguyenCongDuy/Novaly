                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($stories as $story)
                                <tr>
                                    ...
                                    <td>
                                        @if ($story->avatar_url)
                                            <img src="{{ asset('storage/' . $story->avatar_url) }}"
                                                alt="{{ $story->title }}" class="rounded" width="50" height="50">
                                        @else
                                    ...
                                    {{-- Title --}}
                                    <td>
                                       <strong>{{ Str::words($story->title, 4, '...') }}</strong>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('admin.stories.chapters.index', $story->id) }}">
                                                <i class="bx bx-list-ul me-1"></i> Chapters
                                            </a>
                                        </div>
                                    </td>
                                </tr>
