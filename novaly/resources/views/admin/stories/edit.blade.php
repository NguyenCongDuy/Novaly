...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.stories.update', $story->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows="3"
                            placeholder="Nhập mô tả">{{ old('description', $story->description) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">
                            Chọn file ảnh mới (JPEG, PNG, JPG, GIF) tối đa 2MB. Để trống nếu không muốn thay đổi.
                        </small>

                        @if($story->avatar_url)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $story->avatar_url) }}" alt="Current Avatar" class="rounded" width="100" height="100">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">
                            Chọn file ảnh mới (JPEG, PNG, JPG, GIF) tối đa 5MB. Để trống nếu không muốn thay đổi.
                        </small>

                        @if($story->cover_url)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $story->cover_url) }}" alt="Current Cover" class="rounded" width="200">
                                <p class="text-muted small">Ảnh bìa hiện tại</p>
                            </div>
                        @endif
