    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Thêm chương mới cho truyện: {{ $story->title }}</h5>
            ...
            <div class="card-body">
                <form action="{{ route('admin.stories.chapters.store', $story->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select id="access_type"
                            ...
                            <option value="free" {{ old('access_type') === 'free' ? 'selected' : '' }}>Free</option>
                            <option value="coin" {{ old('access_type') === 'coin' ? 'selected' : '' }}>Coin</option>
                            <option value="premium" {{ old('access_type') === 'premium' ? 'selected' : '' }}>Premium</option>
                        </select>
                    ...
                    <div class="mb-3">
                        <p class="text-muted mb-0">
                            Số chương sẽ được tự động tạo dựa trên chương lớn nhất hiện tại của truyện này.
                        </p>
                    </div>
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary me-2">
                            <i class="bx bx-check"></i> Lưu chương
                        </button>
                        <a href="{{ route('admin.stories.chapters.index', $story->id) }}" class="btn btn-secondary">
